...
We implemented a log generator called **[Vgen](https://github.com/WeihuaSun/Vgen)** to generate transaction logs in the Vbox format. You can refer to the **Vgen** code for more details on how to generate logs for various types of transaction histories.
